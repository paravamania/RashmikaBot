...
import RashmikaBot.modules.sql.notes_sql as sql
from RashmikaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from RashmikaBot.__main__ import DATA_IMPORT
from RashmikaBot.modules.helper_funcs.chat_status import user_admin
from RashmikaBot.modules.helper_funcs.alternate import typing_action

# from RashmikaBot.modules.rules import get_rules
import RashmikaBot.modules.sql.rules_sql as rulessql

# from RashikaBot.modules.sql import warns_sql as warnssql
import RashmikaBot.modules.sql.blacklist_sql as blacklistsql
from RashmikaBot.modules.sql import disable_sql as disabledsql

# from RashmikaBot.modules.sql import cust_filters_sql as filtersql
# import RashmikaBot.modules.sql.welcome_sql as welcsql
import RashmikaBot.modules.sql.locks_sql as locksql
from RashmikaBot.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("midukkirashmika2_bot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("midukkirashmika2_bot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `midukkirashmika2_bot-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("midukkirashmika2_bot{}.backup".format(chat_id))  # Cleaning file
