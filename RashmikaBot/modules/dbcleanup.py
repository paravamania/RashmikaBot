...
import RashmikaBot.modules.sql.global_bans_sql as gban_sql
import RashmikaBot.modules.sql.users_sql as user_sql
from RashmikaBot import DEV_USERS, OWNER_ID, dispatcher
